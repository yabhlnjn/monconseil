...
// Vérifier si l'utilisateur est "yassin", sinon le rediriger
if ($_SESSION['user_id'] == 'yassin') {
    header('Location: yassin.php');
}
?>
...
<div class="dashboard-container">
    ...
    <div class="intro"><p>Profs présent: jdfjgbjk</p></div>
    <div><p>Commentaire du conseil de classe: 
        t'es tout seul
    </p></div>
